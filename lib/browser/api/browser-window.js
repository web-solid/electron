...
BrowserWindow.prototype._init = function () {
  ...
  Object.defineProperty(this, 'visibleOnAllWorkspaces', {
    get: () => this.isVisibleOnAllWorkspaces(),
    set: (visible) => this.setVisibleOnAllWorkspaces(visible)
  })

  Object.defineProperty(this, 'simpleFullScreen', {
    get: () => this.isSimpleFullScreen(),
    set: (simple) => this.setSimpleFullScreen(simple)
  })

  Object.defineProperty(this, 'kiosk', {
    get: () => this.isKiosk(),
    set: (kiosk) => this.setKiosk(kiosk)
  })

  Object.defineProperty(this, 'documentEdited', {
  ...
  Object.defineProperty(this, 'representedFilename', {
    get: () => this.getRepresentedFilename(),
